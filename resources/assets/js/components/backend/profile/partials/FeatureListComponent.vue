            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <div class="board-header-left">
                        <h3 class="board-title">{{ trans('My Features') }}</h3>
                    </div>
                    <div class="board-header-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">{{ trans('My Features') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="my-profile-search">
                        ...
                        <div class="profile-top-right">
                            <div class="sort-tab text-right">
                                <a v-bind:href="route('feature.edit.admin')" class="btn btn-primary">{{ trans('Add Feature') }}</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="my-actions">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu actions-dropdown">
                                                    <li><a v-bind:href="route('feature.edit.admin', {'id': item.feature_id})"><i class="fa fa-edit"></i> {{ trans('Edit') }}</a></li>
                                                    <li><a v-bind:href="route('feature.delete.admin', {'id': item.feature_id})" class="delete-feature"><i class="fa fa-close"></i> {{ trans('Delete') }}</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
        props: ['params'],
        mounted: function() {
            this.entities_list = this.params.features;
        }
    }
</script>