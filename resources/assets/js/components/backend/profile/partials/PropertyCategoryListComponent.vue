            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <div class="board-header-left">
                        <h3 class="board-title">{{ trans('Property Categories') }}</h3>
                    </div>
                    <div class="board-header-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">{{ trans('Property Categories') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="my-profile-search">
                        ...
                        <div class="profile-top-right">
                            <div class="sort-tab text-right">
                                <a v-bind:href="route('propertyCategory.edit.admin')" class="btn btn-primary">{{ trans('Add Category') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="my-property-listing">
                        <div class="row grid-row" v-for="item, index in entities_list.data">
                                ...
                                <div class="media my-property">
                                    <div class="media-body align-self-center">
                                        <div class="my-description">
                                            ...
                                            <div class="status">
                                                <p>
                                                    <span><strong>Items:</strong> {{ item.total_properties }}</span>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="my-actions">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu actions-dropdown">
                                                    <li><a v-bind:href="route('propertyCategory.edit.admin', {'id': item.property_category_id})"><i class="fa fa-edit"></i> {{ trans('Edit') }}</a></li>
                                                    <li><a v-bind:href="route('propertyCategory.delete.admin', {'id': item.property_category_id})" class="delete-jobCategory"><i class="fa fa-close"></i> {{ trans('Delete') }}</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <template v-if="item.children">
                                <user-profile-property-category-child :entity_item="item"></user-profile-property-category-child>
                            </template>
                        </div>
                        <hr>
                    </div>
...
<script>
    ...
    export default {
        props: ['params'],
        mounted: function() {
            this.entities_list = this.params.propertyCategories;
        }
    }
</script>
