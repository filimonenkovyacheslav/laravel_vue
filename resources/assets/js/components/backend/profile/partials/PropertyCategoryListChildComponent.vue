    ...
    <div>
        <div class="child-category-row" v-for="child, childIndex in item.children">
                ...
                <div class="media my-property">
                    <div class="media-body align-self-center">
                        <div class="my-description">
                            ...
                            <div class="status">
                                <p>
                                    <span><strong>Items:</strong> {{ child.total_properties }}</span>
                                </p>
                            </div>
                        </div>
                        <div class="my-actions">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu actions-dropdown">
                                    <li><a v-bind:href="route('propertyCategory.edit.admin', {'id': child.property_category_id})"><i class="fa fa-edit"></i> {{ trans('Edit') }}</a></li>
                                    <li><a v-bind:href="route('propertyCategory.delete.admin', {'id': child.property_category_id})" class="delete-jobCategory"><i class="fa fa-close"></i> {{ trans('Delete') }}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <template v-if="child.children">
                <user-profile-property-category-child :entity_item="child"></user-profile-property-category-child>
            </template>
        </div>
    </div>
</template>
