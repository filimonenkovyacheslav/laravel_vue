        ...
        <div class="container">
            <div class="row dashboard-inner-main">
                <div class="col-lg-10 col-md-9 col-sm-12 dashboard-inner-left">
                    <form id="save-form" action="/save-wine" method="post" enctype="multipart/form-data" class="add-frontend-property">
                        <div class="submit-form-wrap">
                            ...
                            <wine-edit-admin-categories></wine-edit-admin-categories>
                            <wine-edit-admin-images></wine-edit-admin-images>
                            <wine-edit-admin-location></wine-edit-admin-location>
                ...
                <div class="col-lg-2 col-md-3 col-sm-12 dashboard-inner-right">
                    <div class="dashboard-sidebar">
                        <div class="dashboard-sidebar-inner">
                            ...
                            <a v-if="entity && entity.slug" :href="route('wine.view.frontend', {'slug': entity.slug})" class="btn btn-default btn-block">{{ trans('View') }}</a>
                            <a :href="route('user.profile.wines')" class="btn btn-default btn-block">{{ trans('Wine List') }}</a>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <wine-edit-admin-add-category></wine-edit-admin-add-category>
...
<script>
    ...
    export default {
        ...
        created: function() {
            ...
            axios.post('/api/wine' + id, { _token: this.csrf }).then(function(response) {
        ...
        methods: {
            onSubmit: function() {
                ...
                axios.post('/save-wine', self.entity).then(function(response) {
