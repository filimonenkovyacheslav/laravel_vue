...
<script>
    export default {
        ...
        mounted: function() {
            ...
            this.$eventHub.$on('wineCategoryLoaded', function() {
                self.getWineCategories();
            });
        ...
        methods: {
            ...
            getWineCategories: function() {
                var self = this;
                axios.post('/api/wineCategories', { _token: this.csrf }).then(function(response) {
