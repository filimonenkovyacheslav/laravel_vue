        ...
        <div class="container">
            <div class="row dashboard-inner-main">
                <div class="col-lg-10 col-md-9 col-sm-12 dashboard-inner-left">
                    <form id="save-form" action="/save-furniture" method="post" enctype="multipart/form-data" class="add-frontend-property">
                        <div class="submit-form-wrap">
                            ...
                            <furniture-edit-admin-categories></furniture-edit-admin-categories>
                            <furniture-edit-admin-images></furniture-edit-admin-images>
                            <furniture-edit-admin-location></furniture-edit-admin-location>
                ...
                <div class="col-lg-2 col-md-3 col-sm-12 dashboard-inner-right">
                    <div class="dashboard-sidebar">
                        <div class="dashboard-sidebar-inner">
                            ...
                            <a v-if="entity && entity.slug" :href="route('furniture.view.frontend', {'slug': entity.slug})" class="btn btn-default btn-block">{{ trans('View') }}</a>
                            <a :href="route('user.profile.furnitures')" class="btn btn-default btn-block">{{ trans('Furniture List') }}</a>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <furniture-edit-admin-add-category></furniture-edit-admin-add-category>
...
<script>
    ...
    export default {
        ...
        created: function() {
            ...
            axios.post('/api/furniture' + id, { _token: this.csrf }).then(function(response) {
        ...
        methods: {
            onSubmit: function() {
                ...
                axios.post('/save-furniture', self.entity).then(function(response) {
