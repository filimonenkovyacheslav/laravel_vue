...
<script>
    export default {
        ...
        mounted: function() {
            ...
            this.$eventHub.$on('furnitureCategoryLoaded', function() {
                self.getFurnitureCategories();
            });
        ...
        methods: {
            ...
            getFurnitureCategories: function() {
                var self = this;
                axios.post('/api/furnitureCategories', { _token: this.csrf }).then(function(response) {
