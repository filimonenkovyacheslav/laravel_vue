        ...
        <div class="container">
            <div class="row dashboard-inner-main">
                <div class="col-lg-10 col-md-9 col-sm-12 dashboard-inner-left">
                    <form id="save-form" action="/save-product" method="post" enctype="multipart/form-data" class="add-frontend-property">
                        <div class="submit-form-wrap">
                            ...
                            <product-edit-admin-categories></product-edit-admin-categories>
                            <product-edit-admin-images></product-edit-admin-images>
                            <product-edit-admin-location></product-edit-admin-location>
                ...
                <div class="col-lg-2 col-md-3 col-sm-12 dashboard-inner-right">
                    <div class="dashboard-sidebar">
                        <div class="dashboard-sidebar-inner">
                            ...
                            <a v-if="entity && entity.slug" :href="route('product.view.frontend', {'slug': entity.slug})" class="btn btn-default btn-block">{{ trans('View') }}</a>
                            <a :href="route('user.profile.products')" class="btn btn-default btn-block">{{ trans('Product List') }}</a>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <product-edit-admin-add-category></product-edit-admin-add-category>
...
<script>
    ...
    export default {
        ...
        created: function() {
            ...
            axios.post('/api/product' + id, { _token: this.csrf }).then(function(response) {
        ...
        methods: {
            onSubmit: function() {
                ...
                axios.post('/save-product', self.entity).then(function(response) {
