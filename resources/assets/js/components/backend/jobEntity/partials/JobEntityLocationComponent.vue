        ...
        <div class="add-tab-content">
            <div class="add-tab-row  push-padding-bottom">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="address">{{ trans('State') }}</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="neighborhood">{{ trans('Neighborhood') }}</label>
                            <input type="text" name="neighborhood" id="neighborhood" v-model="$parent.entity.neighborhood" class="form-control"/>
                        </div>
                    </div>
                </div>
            </div>
            <div class="add-tab-row">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <!--<button id="find" class="btn btn-primary">{{ trans('Place the pin the address above') }}</button>-->
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <!-- <label for="map-street-view">Google Map Street View</label>
                            <select name="map_opts[street_view]" id="map-street-view" class="form-control" data-live-search="false">
