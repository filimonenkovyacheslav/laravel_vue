        ...
        <div class="container">
            <div class="row dashboard-inner-main">
                <div class="col-lg-10 col-md-9 col-sm-12 dashboard-inner-left">
                    <form id="save-form" action="/save-design" method="post" enctype="multipart/form-data" class="add-frontend-property">
                        <div class="submit-form-wrap">
                                            ...
                                            <div class="col-sm-12" v-if="params.user_role=='administrator'">
                                                <div :class="['form-group', errorsList.author ? 'has-danger' : '']">
                                                    ...
                                                    <input type="text" name="author_name" id="author_name" v-model="entity.author_name"
                                                           :class="['form-control', errorsList.author ? 'form-control-danger' : '']" :placeholder="trans('Enter author name or ID')" />
                            ...
                            <design-edit-admin-categories></design-edit-admin-categories>
                            <design-edit-admin-images></design-edit-admin-images>
                            <design-edit-admin-location></design-edit-admin-location>
                ...
                <div class="col-lg-2 col-md-3 col-sm-12 dashboard-inner-right">
                    <div class="dashboard-sidebar">
                        <div class="dashboard-sidebar-inner">
                            ...
                            <a v-if="entity && entity.slug" :href="route('design.view.frontend', {'slug': entity.slug})" class="btn btn-default btn-block">{{ trans('View') }}</a>
                            <a :href="route('user.profile.designs')" class="btn btn-default btn-block">{{ trans('Go to List') }}</a>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <design-edit-admin-add-category></design-edit-admin-add-category>
...
<script>
    ...
    export default {
        ...
        created: function() {
            ...
            axios.post('/api/design' + id, { _token: this.csrf }).then(function(response) {
        ...
        methods: {
            onSubmit: function() {
                ...
                axios.post('/save-design', self.entity).then(function(response) {
