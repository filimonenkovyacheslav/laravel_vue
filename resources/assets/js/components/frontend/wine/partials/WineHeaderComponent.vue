                ...
                <div class="col-sm-12">
                    <div class="header-detail">
                        <div class="header-left">
                            ...
                            <wine-view-frontend-price :entityData="params.entity" :className="'single-view'"></wine-view-frontend-price>
                        </div>
                        <div class="header-right">
                            <div class="hidden-sm hidden-xs">
                                <wine-view-frontend-labels  :entityData="params.entity" :className="''"></wine-view-frontend-labels>
                            </div>
                            <wine-view-frontend-actions :entityData="params.entity" :userRole="params.user_role" :items="['share-btn', 'favorite-btn', 'print-btn']"></wine-view-frontend-actions>
                        </div>
                    </div>
                </div>
            </div>
