                ...
                <div class="col-sm-12">
                    <div class="header-detail">
                        <div class="header-left">
                            ...
                            <furniture-view-frontend-price :entityData="params.entity" :className="'single-view'"></furniture-view-frontend-price>
                        </div>
                        <div class="header-right">
                            <div class="hidden-sm hidden-xs">
                                <furniture-view-frontend-labels  :entityData="params.entity" :className="''"></furniture-view-frontend-labels>
                            </div>
                            <furniture-view-frontend-actions :entityData="params.entity" :userRole="params.user_role" :items="['share-btn', 'favorite-btn', 'print-btn']"></furniture-view-frontend-actions>
                        </div>
                    </div>
                </div>
            </div>
