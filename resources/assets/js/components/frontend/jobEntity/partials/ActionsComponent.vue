<template>
    <ul class="actions">
        ...
        <li class="favorite-btn" v-if="inArray('favorite-btn', items)" v-on:click="toggleFavoriteJobEntity(entityData.id)">
        ...
        <li class="edit-btn" v-if="userRole=='administrator'">
            <span class="edit_entity" title="Edit Job">
                <a v-bind:href="route('jobEntity.edit.admin', {'id': entityData.id})" target="_blank">
