        ...
        <div class="page-content">
            <div class="page-content-header">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <wineseller-view-frontend-detail :params="params" :captcha="captcha"></wineseller-view-frontend-detail>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div id="content-area">
                                <wineseller-view-frontend-tabs :params="params"></wineseller-view-frontend-tabs>
                            </div>
                        </div>
