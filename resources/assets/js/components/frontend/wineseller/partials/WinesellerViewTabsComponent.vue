        ...
        <div class="detail-bar">
            <div class="detail-content-tabber">
                <div class="tab-content" id="agencyTabContent">
                    ...
                    <div v-if="params.user.wines && params.user.wines.total>0" class="tab-pane fade" id="wines" role="tabpanel" aria-labelledby="wines-tab" style="display: block !important;opacity: 1 !important;">
                        <div class="profile-properties detail-block">
                            ...
                            <div>
                                <div class="grid-view">
                                    <wine-list-frontend-list-item :entities="params.user.wines.data" :params="params"></wine-list-frontend-list-item>
                                </div>
                                <pagination :pagination="params.user.wines"></pagination>
                            </div>
                        </div>
                    </div>
                </div>
