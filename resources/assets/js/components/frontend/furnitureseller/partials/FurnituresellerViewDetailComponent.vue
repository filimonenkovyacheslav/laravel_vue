        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <ul class="detail-tabs nav nav-tabs" id="agencyTab" role="tablist">
                    ...
                    <li v-if="params.user.furnitures && params.user.furnitures.total > 0" class="nav-item">
                        <a class="nav-link" id="furnitures-tab" data-toggle="tab" href="#furnitures" role="tab" aria-controls="furnitures" aria-selected="false">{{ trans('Furniture') }}</a>
                    </li>
                    <li class="nav-item">
