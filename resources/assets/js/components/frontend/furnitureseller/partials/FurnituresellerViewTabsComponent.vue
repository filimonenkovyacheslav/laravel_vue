        ...
        <div class="detail-bar">
            <div class="detail-content-tabber">
                <div class="tab-content" id="agencyTabContent">
                    ...
                    <div v-if="params.user.furnitures && params.user.furnitures.total>0" class="tab-pane fade" id="furnitures" role="tabpanel" aria-labelledby="furnitures-tab" style="display: block !important;opacity: 1 !important;">
                        <div class="profile-properties detail-block">
                            ...
                            <div>
                                <div class="grid-view">
                                    <furniture-list-frontend-list-item :entities="params.user.furnitures.data" :params="params"></furniture-list-frontend-list-item>
                                </div>
                                <pagination :pagination="params.user.furnitures"></pagination>
                            </div>
                        </div>
                    </div>
                </div>
