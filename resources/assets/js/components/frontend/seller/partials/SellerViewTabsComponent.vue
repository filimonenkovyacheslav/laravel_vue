        ...
        <div class="detail-bar">
            <div class="detail-content-tabber">
                <div class="tab-content" id="agencyTabContent">
                    ...
                    <div v-if="params.user.goods && params.user.goods.total>0" class="tab-pane fade" id="goods" role="tabpanel" aria-labelledby="goods-tab" style="display: block !important;opacity: 1 !important;">
                        <div class="profile-properties detail-block">
                            <div class="property-filter-wrap table-list">
                                <div class="detail-title no-margin table-cell">
                                    <span>{{ trans('Marketplace items') }}</span>
                                </div>
                            ...
                            <div>
                                <div class="grid-view">
                                    <product-list-frontend-list-item :entities="params.user.goods.data" :params="params"></product-list-frontend-list-item>
                                </div>
                                <pagination :pagination="params.user.goods"></pagination>
                            </div>
                        </div>
                    </div>
                </div>
