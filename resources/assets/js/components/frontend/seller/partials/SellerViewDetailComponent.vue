        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <ul class="detail-tabs nav nav-tabs" id="agencyTab" role="tablist">
                    ...
                    <li v-if="params.user.goods && params.user.goods.total > 0" class="nav-item">
                        <a class="nav-link" id="goods-tab" data-toggle="tab" href="#goods" role="tab" aria-controls="goods" aria-selected="false">{{ trans('Marketplace items') }}</a>
                    </li>
                    <li class="nav-item">
