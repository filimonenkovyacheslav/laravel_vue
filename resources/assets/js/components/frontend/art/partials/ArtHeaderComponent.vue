                ...
                <div class="col-sm-12">
                    <div class="header-detail">
                        <div class="header-left">
                            ...
                            <art-view-frontend-price :entityData="params.entity" :className="''"></art-view-frontend-price>
                        </div>
                        <div class="header-right">
                            <div class="hidden-sm hidden-xs">
                                <art-view-frontend-labels  :entityData="params.entity" :className="''"></art-view-frontend-labels>
                            </div>
                            <art-view-frontend-actions :entityData="params.entity" :userRole="params.user_role" :items="['share-btn', 'favorite-btn', 'print-btn']"></art-view-frontend-actions>
                        </div>
                    </div>
                </div>
            </div>
