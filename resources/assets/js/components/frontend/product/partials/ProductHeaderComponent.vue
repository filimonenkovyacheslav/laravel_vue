                ...
                <div class="col-sm-12">
                    <div class="header-detail">
                        <div class="header-left">
                            ...
                            <product-view-frontend-price :entityData="params.entity" :className="'single-view'"></product-view-frontend-price>
                        </div>
                        <div class="header-right">
                            <div class="hidden-sm hidden-xs">
                                <product-view-frontend-labels  :entityData="params.entity" :className="''"></product-view-frontend-labels>
                            </div>
                            <product-view-frontend-actions :entityData="params.entity" :userRole="params.user_role" :items="['share-btn', 'favorite-btn', 'print-btn']"></product-view-frontend-actions>
                        </div>
                    </div>
                </div>
            </div>
