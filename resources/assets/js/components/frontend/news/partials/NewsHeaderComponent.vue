                    ...
                    <div class="header-detail">
                        ...
                        <div class="header-right">
                            <div class="hidden-sm hidden-xs">
                                <news-view-frontend-labels  :entityData="params.entity" :className="''"></news-view-frontend-labels>
                            </div>
                            <news-view-frontend-actions :entityData="params.entity" :userRole="params.user_role" :items="['share-btn', 'favorite-btn', 'print-btn']"></news-view-frontend-actions>
                        </div>
                    </div>
                </div>
            </div>
