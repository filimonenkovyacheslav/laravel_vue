<template>
    <ul class="actions">
        ...
        <li class="favorite-btn" v-if="inArray('favorite-btn', items)" v-on:click="toggleFavoriteProperty(entityData.id)">
        ...
        <li class="edit-btn" v-if="userRole=='administrator'">
            <span class="edit_entity" title="Edit Property">
                <a v-bind:href="route('property.edit.admin', {'id': entityData.id})" target="_blank">
                    <span><i class="fa fa-edit"></i></span>
                </a>
            </span>
        </li>
        <li class="edit-btn" v-if="userRole=='administrator'">
            <span class="delete_entity" title="Delete Property">
                <a v-bind:href="route('property.delete.admin', {'id': entityData.id})">
                    <span><i class="fa fa-times"></i></span>
                </a>
            </span>
        </li>
        <!--<li class="camera-btn" v-if="inArray('camera-btn', items)">
            <span title="Photos"><i class="fa fa-camera"></i></span>
        </li>
        <li class="compare-btn" v-if="inArray('compare-btn', items)">
            <span class="compare-property" title="Compare Properties"><i class="fa fa-plus"></i></span>
        </li>
        <li class="print-btn" v-if="inArray('print-btn', items)" v-on:click="window.print();">
