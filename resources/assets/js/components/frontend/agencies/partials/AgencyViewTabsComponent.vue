        ...
        <div class="detail-bar">
            <div class="detail-content-tabber">
                <div class="tab-content" id="agencyTabContent">
                    ...
                    <!--<div class="tab-pane fade" id="hours" role="tabpanel" aria-labelledby="hours-tab" style="display: block !important;opacity: 1 !important;">-->
                        <!--<div class="profile-hours detail-block" v-html="params.user.opening_hours"></div>-->
                    <!--</div>-->
					<div v-if="params.user.services && params.user.services.length" class="tab-pane fade" id="services" role="tabpanel" aria-labelledby="services-tab" style="display: block !important;opacity: 1 !important;">
                        <div class="profile-overview detail-block">
                            <div class="detail-title">
                                <span>{{ params.user.role == 'professional' ? trans('Services') : trans('Products & Services') }}</span>
                            </div>
                    ...
                    <div v-if="params.user.agency_agents == 'agency' && params.user.agents && params.user.agents.length" class="tab-pane fade" id="agents" role="tabpanel" aria-labelledby="agents-tab" style="display: block !important;opacity: 1 !important;">
                        <div class="profile-agents detail-block">
                            <div class="property-filter-wrap">
                                <div class="detail-title no-margin">
                                    <span>{{ params.agency_agents[params.user.type].title }}</span>
                                </div>
                            </div>
                            <agency-list-frontend-list-item :params="params" :entities="params.user.agents" :is_grid="true"></agency-list-frontend-list-item>
                        </div>
                    </div>
                    <div v-if="params.user.designs && params.user.designs.total>0" class="tab-pane fade" id="designs" role="tabpanel" aria-labelledby="design-tab" style="display: block !important;opacity: 1 !important;">
                        <div class="profile-properties detail-block">
                            ...
                            <div>
                                <div class="grid-view">
                                    <design-list-frontend-list-item :entities="params.user.designs.data" :params="params"></design-list-frontend-list-item>
                                </div>
                                <pagination :pagination="params.user.designs"></pagination>
                            </div>
                        </div>
                    </div>
                    <div v-if="params.user.type != 'professional' && params.user.properties && params.user.properties.total>0" class="tab-pane fade" id="listing" role="tabpanel" aria-labelledby="listing-tab" style="display: block !important;opacity: 1 !important;">
                        <div class="profile-properties detail-block">
                            <div class="property-filter-wrap">
                                <div class="detail-title no-margin">
                                    <span>{{ trans('Listings') }}</span>
                                </div>
                            </div>
                            <div>
                                <div class="grid-view">
                                    <property-list-frontend-list-item :entities="params.user.properties.data" :params="params"></property-list-frontend-list-item>
                                </div>
                                <pagination :pagination="params.user.properties"></pagination>
                            </div>
                        </div>
                    </div>
                    <!--<div class="tab-pane fade" id="location" role="tabpanel" aria-labelledby="location-tab" style="display: block !important;opacity: 1 !important;">-->
