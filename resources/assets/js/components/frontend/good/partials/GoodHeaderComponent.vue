                ...
                <div class="col-sm-12">
                    <div class="header-detail">
                        <div class="header-left">
                            ...
                            <good-view-frontend-price :entityData="params.entity" :className="'single-view'"></good-view-frontend-price>
                        </div>
                        <div class="header-right">
                            <div class="hidden-sm hidden-xs">
                                <good-view-frontend-labels  :entityData="params.entity" :className="''"></good-view-frontend-labels>
                            </div>
                            <good-view-frontend-actions :entityData="params.entity" :userRole="params.user_role" :items="['share-btn', 'favorite-btn', 'print-btn']"></good-view-frontend-actions>
                        </div>
                    </div>
                </div>
            </div>
