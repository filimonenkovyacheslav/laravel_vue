<template>
    <div id="section-body" class="">
        <div class="container">
            <page-breadcrumbs :title="trans('All Marketplace Items') + setSearchLocation(trans('in'))"></page-breadcrumbs>
            <page-header :title="trans('All Marketplace Items') + setSearchLocation(trans('in'))" :entities="params.entities" :autorized="params.user_role" :switchView="true" defGrid="btn-grid"></page-header>
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 container-sidebar">
                    <aside id="sidebar" class="sidebar-list-white">
                        <good-filters-widget :params="params"></good-filters-widget>
                    </aside>
                    ...
                    <div id="content-area">
                        <div class="property-listing grid-view">
                            <template v-if="params.entities && params.entities.data && params.entities.data.length">
                                <good-list-frontend-list-item :entities="params.entities.data" :params="params" ></good-list-frontend-list-item>
