        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <ul class="detail-tabs nav nav-tabs" id="agencyTab" role="tablist">
                    ...
                    <li v-if="params.user.products && params.user.products.total > 0" class="nav-item">
                        <a class="nav-link" id="products-tab" data-toggle="tab" href="#products" role="tab" aria-controls="products" aria-selected="false">{{ trans('Products') }}</a>
                    </li>
                    <li class="nav-item">
