            ...
            <div :class="['container', params.user.headerMedia.type == 2 ? 'container-video-bg' : '']">
                <div class="page-title breadcrumb-top">
                    <div class="page-title-left">
                        <h1 class="title-head">{{ params.user.first_name}} {{ params.user.last_name}}</h1>
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">{{ params.user.first_name}} {{ params.user.last_name}}</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="page-content">
            <div class="page-content-header">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <artist-view-frontend-detail :params="params" :captcha="captcha"></artist-view-frontend-detail>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div id="content-area">
                                <artist-view-frontend-tabs :params="params"></artist-view-frontend-tabs>
                            </div>
                        </div>
