        ...
        <div class="detail-bar">
            <div class="detail-content-tabber">
                <div class="tab-content" id="agencyTabContent">
                    <div v-if="params.user.description && params.user.description.length" class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab" style="display: block !important;opacity: 1 !important;">
                        <div class="profile-overview detail-block">
                            <div class="detail-title">
                                <span>{{ params.user.role == 'artist' ? trans('Biography') : trans('Overview') }}</span>
                            </div>
                    ...
                    <div v-if="params.user.arts && params.user.arts.total>0" class="tab-pane fade" id="art" role="tabpanel" aria-labelledby="art-tab" style="display: block !important;opacity: 1 !important;">
                        <div class="profile-properties detail-block">
                            <div class="property-filter-wrap">
                                <div class="detail-title no-margin">
                                    <span>{{ trans('Artworks') }}</span>
                                </div>
                            </div>
                            <div>
                                <div class="grid-view">
                                    <art-list-frontend-list-item :entities="params.user.arts.data" :params="params"></art-list-frontend-list-item>
                                </div>
                                <pagination :pagination="params.user.arts"></pagination>
                            </div>
                        </div>
                    </div>
                </div>
