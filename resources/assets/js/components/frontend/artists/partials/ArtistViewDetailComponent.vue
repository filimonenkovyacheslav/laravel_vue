            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <ul class="detail-tabs nav nav-tabs" id="agencyTab" role="tablist">
                    <li v-if="params.user.description && params.user.description.length" class="nav-item">
                        <a class="nav-link active" id="overview-tab" data-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">{{ params.user.role == 'artist' ? trans('Biography') : trans('Overview') }}</a>
                    </li>
                    ...
                    <li v-if="params.user.arts && params.user.arts.total > 0" class="nav-item">
                        <a class="nav-link" id="art-tab" data-toggle="tab" href="#art" role="tab" aria-controls="arts" aria-selected="false">{{ trans('Artworks') }}</a>
                    </li>
                    <li class="nav-item">
