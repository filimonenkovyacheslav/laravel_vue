        ...
        <form action="/agent-send-message" method="POST">
            <div class="media agent-media" v-if="params.entity.user && params.entity.user.type!='administrator'">
                <div class="media-left figure-block">
                    <a :href="route('artist.view.frontend', {'slug': getCompanySlug(params.entity.user)})">
                        <div class="figure-image"><img :src="getImageUrl(params.entity.user.photoImage.name)"></div>
                    </a>
                </div>
                <div class="media-body">
                    <strong>
                        <a :href="route('artist.view.frontend', {'slug': getCompanySlug(params.entity.user)})">{{ trans('View my art') }}</a>
                    </strong>
            ...
            <input type="hidden" name="entity_permalink" :value="route('art.view.frontend', {'slug': params.entity.slug})">
