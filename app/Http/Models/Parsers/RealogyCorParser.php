<?php
    ...
    class RealogyCorParser extends BaseParser
    {
        public static $parserParams = ['skip'];
        public static $userName = '';
        public static $userEmail = 'info@medicaleer';
        public static $imageName = 'medicaleer_realogycor_';
        ...
        public static function run(Parser $parser)
        {
            ...
            //static::deleteImages(); return true;
    
            static::prepareTempDir('realogycor_temp');
            ...
            foreach (static::$brands as $brand) {
                for($k = $params['skip']; $k <= $end; $k += $limit) {
                    ...
                    if($blockNum >= static::$maxBlocks) {
                        Setting::setValue('parsers', 'realogycor_skip', $k);
                        static::$properties = [];
        ...
        public static function parse($response, $info, $request)
        {
            ...
            switch($reqType) {
                case 'list':
                    ...
                    ParserLog::saveUrlData(7, $request->url, 'list=> ' . $response);
                ...
                case 'property':
                    ...
                    ParserLog::saveUrlData(7, $request->url, 'property=> ' . $response);
                    static::controlTokenApi();
    ...
    //            print_r($data['price']);
        ...
        {
            if (($handle = fopen("/home/uploads_name3.csv", "r")) !== FALSE) {
        ...
        public static function compressImages($params)
        {
            ...
            do {
                ...
                $round++;
                $all += $cntUploads;
                Setting::setValue('parsers', 'realogycor_last', $last);
