<?php
    ...
    class RaywhiteruralParser extends BaseParser
    {
        public static $parserParams = ['locations'];
        public static $userName = '';
        public static $userEmail = 'info@medicaleer.com';
        public static $imageName = 'medicaleer_rwr_';
        public static $parseLimit = 0;
        public static $parseBlockLimit = 10;
        ...
        public static $propTypes = [
            ...
            'House' => 2, 'Villa' => 2, 'Acreage/Semi-Rural' => 2, 'Block of Units' => 2, 'Residential building' => 2, 'Residential Property' => 2, 'Bungalow' => 2, 'Terrace' => 2, 'Alpine' => 2, 'Semi-Detached' => 2,
            'Rental Property' => 2,
            'Commercial' => 6,
            'Business office' => [6, 1],
            ...
            'Retirement' => 7,
            'Townhouse' => 9,
            'Land' => 11, 'Vacant Land' => 11, 'Acreage' => 11,
            'Other' => 15,
            ];
        
        public static $propRentSchedule = ['Daily' => 1, 'Weekly' => 2, 'Monthly' => 3, 'Yearly' => 3];
        ...
        public static function run(Parser $parser)
        {
            ...
            static::prepareTempDir('rwr_temp');
            static::$imageName .= date('YmdHis').'_';
            
            $curl = new RollingCurl([$model . 'Parser', 'parse']);
            $curl->setReferer('https://raywhiterurallivestock.com.au/');
            ...
            $curl->setProxies(static::getProxyList(), 'http', 'https://raywhiterurallivestock.com.au/', 'raywhiterurallivestock', 700);
            static::setCurl($curl);
        ...
        public static function parse($response, $info, $request)
        {
            ...
            switch($reqType) {
                case 'list':
                    ...
                    if(!isset($obj->params) && $request->repeat < 3) {
                        $request->repeat++;
                        $curl->add($request);
                ...
                case 'property':
                    ...
                    foreach ($props as $prop_name => $prop_val) {
                        ...
                        switch ($prop_name) {
                            ...
                            case 'address':
                                sleep(1);
                                $link = 'https://geocoder.ls.hereapi.com/6.2/geocode.json?searchtext='.str_replace(' ', '%20', $prop_val).'&gen=8&apiKey=Al-pQcxe5clM9f_03bItLzPNrCLLC3Wg5L5j1ZeWVaY&language=en-US';
