...
class Professional extends \App\Http\Models\BaseModel
{
	/**
	...
	public static $type = 'professional';
	public static $tableName = 'professionals';
	...
	{
		return static::join('users', 'professionals.user_id', '=', 'users.id')
