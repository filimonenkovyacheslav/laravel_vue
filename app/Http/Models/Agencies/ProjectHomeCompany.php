...
class ProjectHomeCompany extends \App\Http\Models\BaseModel
{
	use Sluggable;
	...
	public static $type = 'project_home_company';
	public static $tableName = 'project_home_companies';
		...
		return [
			'relation' => [
				...
				'description' => [
					'index' => 'description',
					'type' => 'textarea',
					'label' => __('About Project Home Company'),
