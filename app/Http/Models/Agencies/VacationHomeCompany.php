...
class VacationHomeCompany extends \App\Http\Models\BaseModel
{
	use Sluggable;
	...
	public static $type = 'vacation_home_company';
	public static $tableName = 'vacation_home_companies';
		...
		return [
			'relation' => [
				...
				'description' => [
					'index' => 'description',
					'type' => 'textarea',
					'label' => __('About Vacation Home Company'),
