...
class PropertyManagement extends \App\Http\Models\BaseModel
{
	use Sluggable;
	...
	public static $type = 'property_management';
	public static $tableName = 'property_managements';
		...
		return [
			'relation' => [
				...
				'description' => [
					'index' => 'description',
					'type' => 'textarea',
					'label' => __('About Property Management'),
