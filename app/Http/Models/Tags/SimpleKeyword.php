...
class SimpleKeyword extends \App\Http\Models\BaseModel
{
	use Sluggable;
	/**
	...
	public static $tableName = 'simple_keywords';
    ...
    public static function searchKeywords($type, $keyword) {
		...
		$query = static::from('simple_keywords as kd')
		...
		if ($defLang != $langId) {
			$query->leftJoin('simple_keywords as kl', function ($join) use($langId){
